...
public class FileClock implements Runnable {
    ...
    /**
     * Indica se nell'array threads non sono rimasti altri thread oltre che al mio.
     * @return se nell'array threads non sono rimasti altri thread oltre che al mio.
     */
