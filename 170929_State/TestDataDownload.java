...
class NetworkConnection extends Thread implements Osservato{

    private Thread td; // the downloadr
	private Osserva osservatore;
    ...
    public void run() {
        ...
        try {
			...
			osservatore = new Osserva(Thread.currentThread());
            Thread osservato = new Thread(new Osserva(Thread.currentThread()),"TD");
	...
	@Override
	public void setOsservatore(Osservatore o) {
		this.osservatore = (Osserva)o;
	}

	@Override
	public void notifica() {
		this.osservatore.aggiorna();
	}
